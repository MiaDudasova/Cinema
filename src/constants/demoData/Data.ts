...
export const MOVIES: Movie[] = [
  ...
  },
  {
    "id": "tt0413267",
    "name": "Shrek 3",
    "desc": "Reluctantly designated as the heir to the land of Far, Far Away, Shrek hatches a plan to install the rebellious Artie as the new king while Princess Fiona tries to fend off a coup d'̩tat by the jilted Prince Charming.",
